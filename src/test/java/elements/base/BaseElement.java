...
public class BaseElement {
    public static String BaseSalesForceInputElementLocator = "//*[contains(@class,'modal-body')]//span[text()='%s']" +
            "/ancestor::div[contains(@class, 'uiInput')]";
    public static String BaseLightningInputElementLocator = "//*[contains(@class, 'modal-body')]//label[text()='%s']/..//child::";
